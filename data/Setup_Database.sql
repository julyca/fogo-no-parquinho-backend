...
('Definitivamente umas das revelações do ano, prof Furlano se superou para se adaptar ao novo ambiente online',8,NOW(),(SELECT id FROM `User` WHERE username LIKE 'dono')),
...
('Its ALL MIGHT!!',10,NOW(),(SELECT id FROM `User` WHERE username LIKE 'kalc')),
('O EAD ta como?',1,NOW(),(SELECT id FROM `User` WHERE username LIKE 'chorao')),
('Mexer com motor a distancia... é complicado',2,NOW(),(SELECT id FROM `User` WHERE username LIKE 'kalc')),
('Melhor materia de programação do curso!!',10,NOW(),(SELECT id FROM `User` WHERE username LIKE 'rangeru')),
('A nota para essa materia é mais de 8000',10,NOW(),(SELECT id FROM `User` WHERE username LIKE 'julyca')),
('Esse professor não passava nem o gabarito! Agora até tá mudado, mas ainda não entendo nada',3,NOW(),(SELECT id FROM `User` WHERE username LIKE 'chorao')),
('Não entendo nada, pq eu to vendo linux se eu mexo no windows',2,NOW(),(SELECT id FROM `User` WHERE username LIKE 'chorao')),
('A-A-A-AULAAA DO FURLANO!!',7,NOW(),(SELECT id FROM `User` WHERE username LIKE 'DIO')),
('Aula melhorou muito! Mas coloca texto mais simples, as vezes fica dificil de entender',8,NOW(),(SELECT id FROM `User` WHERE username LIKE 'julyca')),
('Se eu tivesse a animação desse professor, teria conseguido acompanhar muito melhor a materia',5,NOW(),(SELECT id FROM `User` WHERE username LIKE 'dono')),
('SEM TEMPO IRMÃO!! Aula boa, mas as tarefas...',7,NOW(),(SELECT id FROM `User` WHERE username LIKE 'DIO')),
('Uma das melhores aulas, parabens!!',9,NOW(),(SELECT id FROM `User` WHERE username LIKE 'rangeru')),
('Redacted',8,NOW(),(SELECT id FROM `User` WHERE username LIKE 'rangeru')),
('TOP D+',10,NOW(),(SELECT id FROM `User` WHERE username LIKE 'julyca')),
('Como assim n ter formulario??',1,NOW(),(SELECT id FROM `User` WHERE username LIKE 'chorao')),
('TESTE DE TI I G N O R E I S S O',8,NOW(),(SELECT id FROM `User` WHERE username LIKE 'admin'));
SELECT * FROM Review;
...
SELECT * FROM UserReviews ORDER BY reviewedUserId;
...
((SELECT id FROM `Review` WHERE feedback LIKE 'Its ALL MIGHT'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM251')),
((SELECT id FROM `Review` WHERE feedback LIKE 'Melhor materia de programação do curso!!'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM251')),
((SELECT id FROM `Review` WHERE feedback LIKE 'A nota para essa materia é mais de 8000'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM251')),
((SELECT id FROM `Review` WHERE feedback LIKE 'Esse professor não passava nem o gabarito! Agora até tá mudado, mas ainda não entendo nada'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM253')),
...
((SELECT id FROM `Review` WHERE feedback LIKE 'Definitivamente umas das revelações do ano, prof Furlano se superou para se adaptar ao novo ambiente online'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM253')),
...
((SELECT id FROM `Review` WHERE feedback LIKE 'TOP D+'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM304')),
((SELECT id FROM `Review` WHERE feedback LIKE 'Como assim n ter formulario??'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM304')),
((SELECT id FROM `Review` WHERE feedback LIKE 'TESTE DE TI I G N O R E I S S O'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM304')),
...
((SELECT id FROM `Review` WHERE feedback LIKE 'Se eu tivesse a animação desse professor, teria conseguido acompanhar muito melhor a materia'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM306')),
((SELECT id FROM `Review` WHERE feedback LIKE 'SEM TEMPO IRMÃO!! Aula boa, mas as tarefas...'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM306')),
((SELECT id FROM `Review` WHERE feedback LIKE 'Uma das melhores aulas, parabens!!'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM306')),
...
((SELECT id FROM `Review` WHERE feedback LIKE 'odei omuito tudo isso'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM303')),
((SELECT id FROM `Review` WHERE feedback LIKE 'O EAD ta como?'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM303')),
((SELECT id FROM `Review` WHERE feedback LIKE 'Mexer com motor a distancia... é complicado'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM303')),
((SELECT id FROM `Review` WHERE feedback LIKE 'Eu legitimamente não tenho ideia do que está acontecendo. . .'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM225')),
((SELECT id FROM `Review` WHERE feedback LIKE 'Aula melhorou muito! Mas coloca texto mais simples, as vezes fica dificil de entender'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM225')),
((SELECT id FROM `Review` WHERE feedback LIKE 'A-A-A-AULAAA DO FURLANO!!'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM225')),
((SELECT id FROM `Review` WHERE feedback LIKE 'Não entendo nada, pq eu to vendo linux se eu mexo no windows'),(SELECT id FROM `Subject` WHERE code LIKE 'ECM225'));
SELECT * FROM SubjectReviews ORDER BY reviewedSubjectId;
